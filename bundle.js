...
},{"./adapters/http":3,"./adapters/xhr":3,"./core/enhanceError":13,"./helpers/normalizeHeaderName":25,"./utils":29,"_process":34}],18:[function(require,module,exports){
'use strict';
...
module.exports={
  "_args": [
    [
      "axios@0.21.4",
      "/home/dundella/Desktop/frane/ispit-git"
    ]
  ],
  "_from": "axios@0.21.4",
  "_id": "axios@0.21.4",
  ...
  "_spec": "0.21.4",
  "_where": "/home/dundella/Desktop/frane/ispit-git",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
...
},{"./lib/randomstring":37}],36:[function(require,module,exports){
...
},{"array-uniq":1}],37:[function(require,module,exports){
"use strict";
...
},{"./charset.js":36,"randombytes":38}],38:[function(require,module,exports){
...
},{"_process":34,"buffer":32}],39:[function(require,module,exports){
"use strict";
...
function fetchCountries(enteredText) {
  ...
  var url = "https://restcountries.com/v3.1/name/".concat(enteredText); //const url = "https://restcountries.com/v3.1/name/" + enteredText;
...
},{"./setup":41}],41:[function(require,module,exports){
"use strict";
...
function setup() {
  ...
  searchButton.addEventListener("click", function () {
    ...
    var enteredText = searchInput.value.trim();
    ...
    (0, _countries["default"])(enteredText).then(function (countriesArray) {
      console.log("countriesArray", countriesArray);
      var list = (0, _list["default"])(countriesArray);
...
},{"./countries":39,"./views/layout":42,"./views/list":43,"randomstring":35}],42:[function(require,module,exports){
"use strict";
...
function createList(countriesArray) {
  ...
  for (var i = 0; i < countriesArray.length; i++) {
    ...
    var name = c.name.official;
    var capital = c.capital[0];
    var region = c.region;
    var newCountry = "<li> ".concat(name, " - ").concat(capital, " - ").concat(region, " </li>");
